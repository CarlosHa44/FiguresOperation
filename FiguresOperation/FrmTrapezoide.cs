...
namespace FiguresOperation
{
    ...
    {
        private static FrmTrapezoide mInstance;
        private TrapezoideIsoceles obj = new TrapezoideIsoceles();
        ...
        {
            obj.InitializeData(txtBaseMayor, txtBaseMenor, txtAltura, txtPerimeter, txtArea, picCanvas);
        }
        ...
        {
            obj.ReadData(txtBaseMayor, txtBaseMenor, txtAltura);

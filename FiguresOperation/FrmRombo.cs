...
namespace FiguresOperation
{
    ...
    {
        private static FrmRombo mInstance;
        private Rhombus obj = new Rhombus();
        ...
        {
            obj.InitializeData(txtDiagonal1,txtDiagonal2,txtPerimeter,txtArea,picCanvas);
        }

        private void btnCalculate_Click(object sender, EventArgs e)
        {
            obj.ResetTransform();
            obj.ReadData(txtDiagonal1, txtDiagonal2);
            obj.PerimeterRhombus();
            obj.AreaRhombus();
